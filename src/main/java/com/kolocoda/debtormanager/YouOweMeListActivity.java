...
public class YouOweMeListActivity extends ActionBarActivity implements YouOweMeListFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_youoweme);
        setTotal();
    ...
    public void setTotal() {
        ...
        String totalFormat = getString(R.string.total, String.format("$" + "%,.2f", Utility.getYouOweTotal(this)));
